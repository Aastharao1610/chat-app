...
// import { PhoneOff, Video, Mic, MicOff, VideoOff, Maximize } from "lucide-react";
...
//     <button
//       onClick={endCall}
//       className="bg-red-500 p-6 rounded-full hover:bg-red-600 transition-all hover:scale-110 shadow-xl"
//     >
...
//       {/* 2️⃣ Incoming Call UI (The Toast/Modal) */}
// {incomingCall && !activeCall && (
//   <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center z-[999] p-4">
//     <div className="bg-slate-900 border border-slate-700 p-8 rounded-3xl text-center shadow-2xl w-full max-w-sm">
//       <div className="w-20 h-20 bg-blue-600 rounded-full mx-auto mb-4 flex items-center justify-center animate-bounce">
...
//         <button
//           onClick={acceptCall}
//           className="bg-green-500 text-white p-5 rounded-full hover:bg-green-600 transition-transform hover:scale-110 shadow-lg shadow-green-900/20"
//         >
//           <Video size={28} />
//         </button>
...
//         <button
//           onClick={rejectCall}
//           className="bg-red-500 text-white p-5 rounded-full hover:bg-red-600 transition-transform hover:scale-110 shadow-lg shadow-red-900/20"
//         >
//           <PhoneOff size={28} />
//         </button>
//       </div>
...
//       {activeCall && (
//         <div className="fixed inset-0 bg-black z-[998] flex items-center justify-center overflow-hidden">
//           {/* Remote Video (Main Background) */}
//           <div className="relative w-full h-full flex items-center justify-center">
//             {/* Tip: We use a wrapper div to ensure the video
//                 always stays centered regardless of aspect ratio
//              */}
//             <video
//               ref={remoteVideoRef}
//               autoPlay
...
// <div className="absolute bottom-28 right-6 w-32 sm:w-48 aspect-[3/4] rounded-2xl overflow-hidden border-2 border-white/20 shadow-2xl z-[1000] bg-slate-800">
//   <video
//     ref={localVideoRef}
//     autoPlay
//     playsInline
//     muted
//     /* scale-x-[-1] mirrors your own camera so it feels natural */
...
//             <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex items-center gap-4 px-6 py-4 bg-white/10 backdrop-blur-xl rounded-full border border-white/20">
//               <button className="p-3 rounded-full bg-white/10 hover:bg-white/20 text-white transition">
//                 <Mic size={24} />
//               </button>

//               <button
//                 onClick={endCall}
//                 className="bg-red-500 p-4 rounded-full hover:bg-red-600 transition-all hover:scale-110 shadow-xl group"
//               >
//                 <PhoneOff
//                   size={28}
